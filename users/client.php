...
for ($c = 0; $c < count($users); $c++) {
    ...
    if (($c == 1) && (!isset($_SESSION['lang'])) && ($_SESSION['role'] == 'client') && ($_SESSION['login'] == $users[1]['login']))
    {
        if ($users[1]['lang'] == 'ru') {
            echo $lang[0]['ru'] . $users[1]['name'] . $lang[3]['ru'];
        } else if ($users[1]['lang'] == 'en') {
            echo $lang[0]['en'] . $users[1]['name'] . $lang[3]['en'];
        } else if ($users[1]['lang'] == 'ua') {
            echo $lang[0]['ua'] . $users[1]['name'] . $lang[3]['ua'];
        } else if ($users[1]['lang'] == 'it') {
            echo $lang[0]['it'] . $users[1]['name'] . $lang[3]['it'];
        }
    } elseif((($c == 1) && ($_SESSION['lang'] == 'ru')) && ($_SESSION['role'] == 'client') && ($_SESSION['login'] == $users[1]['login'])){
        echo $lang[0]['ru'] . $users[1]['name'] . $lang[3]['ru'];
    }else if(($c == 1) && ($_SESSION['lang'] == 'en') && ($_SESSION['role'] == 'client') && ($_SESSION['login'] == $users[1]['login'])){
        echo $lang[0]['en'] . $users[1]['name'] . $lang[3]['en'];
    }else if(($c == 1) && ($_SESSION['lang'] == 'ua') && ($_SESSION['role'] == 'client') && ($_SESSION['login'] == $users[1]['login'])){
        echo $lang[0]['ua'] . $users[1]['name'] . $lang[3]['ua'];
    }else if(($c == 1) && ($_SESSION['lang'] == 'it') && ($_SESSION['role'] == 'client') && ($_SESSION['login'] == $users[1]['login'])){
        echo $lang[0]['it'] . $users[1]['name'] . $lang[3]['it'];
    }

    if (($c == 3) && (!isset($_SESSION['lang'])) && ($_SESSION['role'] == 'client') && (($_SESSION['login']) == $users[3]['login']))
    {
        if ($users[3]['lang'] == 'ru') {
            echo $lang[0]['ru'] . $users[3]['name'] . $lang[3]['ru'];
        } else if ($users[4]['lang'] == 'en') {
            echo $lang[0]['en'] . $users[3]['name'] . $lang[3]['en'];
        } else if ($users[4]['lang'] == 'ua') {
            echo $lang[0]['ua'] . $users[3]['name'] . $lang[3]['ua'];
        } else if ($users[4]['lang'] == 'it') {
            echo $lang[0]['it'] . $users[3]['name'] . $lang[3]['it'];
        }
    }elseif (($c == 3) && ($_SESSION['lang'] == 'ru') && ($_SESSION['role'] == 'client') && (($_SESSION['login']) == $users[3]['login'])) {
        echo $lang[0]['ru'] . $users[3]['name'] . $lang[3]['ru'];
    } else if (($c == 3) && ($_SESSION['lang'] == 'en') && ($_SESSION['role'] == 'client') && (($_SESSION['login']) == $users[3]['login'])) {
        echo $lang[0]['en'] . $users[3]['name'] . $lang[3]['en'];
    } else if (($c == 3) && ($_SESSION['lang'] == 'ua') && ($_SESSION['
    role'] == 'client') && (($_SESSION['login']) == $users[3]['login'])) {
        echo $lang[0]['ua'] . $users[3]['name'] . $lang[3]['ua'];
    } else if (($c == 3) && ($_SESSION['lang'] == 'it') && ($_SESSION['role'] == 'client') && (($_SESSION['login']) == $users[3]['login'])) {
        echo $lang[0]['it'] . $users[3]['name'] . $lang[3]['it'];
    }
}
?>
